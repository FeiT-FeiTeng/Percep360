...
# Define input parameters.
    ...
    channels = 64   # MSPoolAttention dim parameter.
    height = 64     # Spatial height.
    width = 64      # Spatial width.

# Generate a random input tensor.
    x = torch.randn(batch_size, channels, height, width)

# Instantiate the MSPoolAttention module.
    ms_pool_attention = MSPoolAttention(dim=channels)

# Run the forward pass.
    output = ms_pool_attention(x)
