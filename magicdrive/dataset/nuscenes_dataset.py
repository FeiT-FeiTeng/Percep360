...
def Pano2Cam(original_path):  # TODO: move path normalization into config.
    timestamp = original_path.split('__')[-1].split('.')[0]
    return f"{os.environ.get('PANODREAMER_PATH')}/data/pano_data/cameras/full_inter/{timestamp}.jpg"
